...
<%
    ...
    goodsList.stream().distinct().collect(Collectors.toList());
    ...
    <div class="main">
        ...
        <div class="main-content">
            <div class="container-fluid">
                ...
                <form action="<%=path%>/MakeOrderServlet" method="post">
                <div class="row">
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <input type="number" class="form-control" placeholder="用户ID" name="UserName">
                                <br>
                                <input type="text" class="form-control" placeholder="用户地址" name="Adress">
                                <br>
                                <textarea class="form-control" placeholder="备注" rows="1" name="Info"></textarea>
                                <br>
                                ...
                                <label class="fancy-radio">
                                    <input name="BuyWay" value="1" type="radio">
                                    <span><i></i>外卖</span>
                                </label>
                                <label class="fancy-radio">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-right">
                        <input type="submit" class="btn btn-success btn-block"value="提交订单" onsubmit="function postList(){<%request.getSession().setAttribute("selectList", selectList); %>return true}">
                        }
                    </div>
                    </form>
