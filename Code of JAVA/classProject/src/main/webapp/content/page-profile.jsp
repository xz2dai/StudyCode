                        ...
                        <div class="profile-left">
                            ...
                            <div class="profile-header">
                                ...
                                <div class="profile-main">
                                    ...
                                    <span class="online-status status-available">${userInfo.state}</span>
                                </div>
                            ...
                            <div class="profile-detail">
                                ...
                                <div class="text-center">
                                    <div class="top-big-link">
                                        <a class="btn btn-primary" data-toggle="modal" href="#modal-register">Launch modal</a>
                                    </div>
                                </div>
                            </div>
                            <!-- END PROFILE DETAIL -->
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input type="text" name="sex" placeholder="性别..." class="form-birthday form-control"
                       id="sex">
            </div>
            <div class="form-group">
                <label class="" for="phoneNum">电话</label>
                <input type="text" name="phoneNum" placeholder="电话..." class="form-phone form-control"
                       id="phoneNum">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="age" placeholder="年龄..." class="form-age form-control"
                       id="age">
            </div>
            <div class="form-group">
